#!/usr/bin/env python3
"""
Idle inhibitor script for SyndraShell
Prevents system from going to sleep/idle
"""
import sys
...
def handle_registry_global(
    ...
    """Handle global registry events"""
    global_registry = wl_registry.user_data
    
    if iface_name == "wl_compositor":
        global_registry.compositor = wl_registry.bind(
            id_num, WlCompositor, version
        )
        global_registry.surface = global_registry.compositor.create_surface()
...
if __name__ == "__main__":
    setproctitle.setproctitle("syndrashell-inhibit")
    main()
